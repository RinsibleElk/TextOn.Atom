module TextOn.Core.Test.TestVariableLineTokenizer
...
let ``Correctly formatted variable definition``() =
    let lines =
        [
            ...
            ("    \"London\" [$Country = \"U.K.\"] // Comment after condition", [{TokenStartLocation = 5;TokenEndLocation = 12;Token = QuotedString "London"};{TokenStartLocation = 14;TokenEndLocation = 14;Token = OpenBrace};{TokenStartLocation = 15;TokenEndLocation = 22;Token = VariableName("Country")};{TokenStartLocation = 24;TokenEndLocation = 24;Token = Equals};{TokenStartLocation = 26;TokenEndLocation = 31;Token = QuotedString "U.K."};{TokenStartLocation = 32;TokenEndLocation = 32;Token = CloseBrace}])
