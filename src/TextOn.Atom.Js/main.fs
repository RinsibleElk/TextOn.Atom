...
let atomModules =
  [ typeof<TextOnIDE.TextOnIDE>, "TextOn" ]
    ...
    for typ, moduleName in atomModules do
        ...
        let moduleJS =
          [ yield "var CompositeDisposable = require('atom').CompositeDisposable;"
            ...
            yield "var ReactForAtom = require('react-for-atom');"
            yield "var {React} = ReactForAtom;"
            ...
            yield "var GeneratorPane = require('./generator-pane-view');"
            yield ""
