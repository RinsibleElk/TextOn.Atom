      ...
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_Error____Object___FSharpOption_1_Result_1_Error____Object___(Async__get_async$(), LanguageService__parseEditor$(editor), (function(_arg1)
      {
        ...
        if ((matchValue.Items[0.000000].Tag == 0.000000)) 
        {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5685 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
        ...
        else
        {
          if ((matchValue.Items[1.000000].Tag == 0.000000)) 
          {
            ...
            _5685 = Array__Map$Error__Object_Error__Object_((function(item)
            {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5869 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
                return ErrorLinterProvider__mapLint$(editor, item);
              }), n_.Data);
            }
            ...
            var r_ = _5869;
            _5685 = Array__Concat$Object_Object_(Seq__OfList$Object___Object___(List__CreateCons$Object___Object___(r, List__CreateCons$Object___Object___(r_, List__Empty$Object___Object___()))));
          };
        };
        return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _5685);
      }));
    })));
});
...
{
    var _5229;
    return (((window.atom).workspace).open("atom://config/packages/texton", _5229));
});
...
TextOnGenerator__activate$ = (function(x,state)
{
    ...
    x.disp = {Tag: 1.000000, Value: (((window.atom).workspace).onDidChangeActivePaneItem((function(unitVar0)
    {
      ...
      {
        x.sub = {Tag: 1.000000, Value: (e.onDidStopChanging((function(_arg1)
        {
          var _5077;
          var arg10_ = _5077;
