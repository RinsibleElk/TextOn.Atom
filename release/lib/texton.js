...
LanguageService__start$ = (function(unitVar0)
{
    try
    {
      ...
      var child = Process__spawn$(location, Process__fromPath$("mono"), ("--port " + LanguageService__port));
