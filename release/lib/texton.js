      ...
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_Error____Object___FSharpOption_1_Result_1_Error____Object___(Async__get_async$(), LanguageService__parseEditor$(editor), (function(_arg1)
      {
        ...
        if ((matchValue.Items[0.000000].Tag == 0.000000)) 
        {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5566 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
        ...
        else
        {
          if ((matchValue.Items[1.000000].Tag == 0.000000)) 
          {
            ...
            _5566 = Array__Map$Error__Object_Error__Object_((function(item)
            {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5750 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
                return ErrorLinterProvider__mapLint$(editor, item);
              }), n_.Data);
            }
            ...
            var r_ = _5750;
            _5566 = Array__Concat$Object_Object_(Seq__OfList$Object___Object___(List__CreateCons$Object___Object___(r, List__CreateCons$Object___Object___(r_, List__Empty$Object___Object___()))));
          };
        };
        return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _5566);
      }));
    })));
});
...
GeneratorPane__replaceTextOnGeneratorHtmlPanel$ = (function(res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      var _4986;
      var q = ((((TextOnViewHelpers__jq$((("\u003catom-panel id=\u0027" + identity(_4986)) + "\u0027 /\u003e")).addClass("top texton-block texton-html-block")).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedTitle)))).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedAttributes)))).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedVariables))));
      var _5001;
      if (res.CanGenerate) 
      {
        var _5011;
        _5001 = (q.append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(makePaddedGeneratorButton(_5011)))));
      }
      else
      {
        _5001 = q;
      ...
      {
        _5012 = (_q.append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(makePaddedGeneratorOutput(res.Output)))));
      }
      else
      {
        _5012 = _q;
        ...
        return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__openTextOnGeneratorPane$(closeIfNotFound), (function(_arg1)
        {
          return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorStart$(editor, line), (function(_arg2)
          {
            ...
            if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(res)) 
            {
              ...
              {
                var _5048;
                return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _5048);
              }));
            }
            else
            {
...
{
    var _5082;
    return (((window.atom).workspace).open("atom://config/packages/texton", _5082));
});
