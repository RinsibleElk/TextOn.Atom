...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _3755;
      return Async__invokeCont$Unit_Unit_(k, _3755);
    }));
});
      ...
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_Error____Object___FSharpOption_1_Result_1_Error____Object___(Async__get_async$(), LanguageService__parseEditor$(editor), (function(_arg1)
      {
        ...
        if ((matchValue.Items[0.000000].Tag == 0.000000)) 
        {
          ...
          else
          {
            ...
            if (linter) 
            {
              _4557 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
        ...
        else
        {
          if ((matchValue.Items[1.000000].Tag == 0.000000)) 
          {
            ...
            _4557 = Array__Map$Error__Object_Error__Object_((function(item)
            {
          ...
          else
          {
            ...
            if (linter) 
            {
              _4741 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
                return ErrorLinterProvider__mapLint$(editor, item);
              }), n_.Data);
            }
            ...
            var r_ = _4741;
            _4557 = Array__Concat$Object_Object_(Seq__OfList$Object___Object___(List__CreateCons$Object___Object___(r, List__CreateCons$Object___Object___(r_, List__Empty$Object___Object___()))));
          };
        };
        return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _4557);
      }));
    })));
});
...
GeneratorPane__navigateToEditor$ = (function(file,line,col)
{
    ...
    for (var _3741 = 0; _3741 <= (Array__Length$IPane_IPane_(arr) - 1); _3741++)
    {
      (function(idx)
      {
        var pane = arr[idx];
        if ((!found)) 
        {
          ...
          for (var _3740 = 0; _3740 <= (Array__Length$Object_Object_(_arr) - 1); _3740++)
          {
            (function(_idx)
            {
              var item = _arr[_idx];
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToFunction$(fileName, functionName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          ...
          _3673 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _3673 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _3673, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _3771;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _3771);
        })));
      }));
    })), {Tag: 0.000000});
});
...
GeneratorPane__replaceTextOnGeneratorHtmlPanel$Boolean_Boolean = (function(expanded,res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      })), (function(_arg1)
      {
        ...
        var _3977;
        var _ignored0 = (((TextOnViewHelpers__jq$((("\u003catom-panel id=\u0027" + identity(_3977)) + "\u0027 /\u003e")).addClass("top texton-block texton-html-block")).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedTitle)))).appendTo(TextOnViewHelpers__jq$(".texton")));
        return AsyncBuilder__Zero$(Async__get_async$());
      }));
    }));
});
        ...
        return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__openTextOnGeneratorPane$(), (function(_arg1)
        {
          return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorStart$(editor, line), (function(_arg2)
          {
            ...
            if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(res)) 
            {
              ...
              {
                var _4020;
                return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4020);
              }));
            }
            else
            {
...
{
    var _4073;
    return (((window.atom).workspace).open("atom://config/packages/texton", _4073));
});
