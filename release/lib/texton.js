...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _3754;
      return Async__invokeCont$Unit_Unit_(k, _3754);
    }));
});
      ...
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_Error____Object___FSharpOption_1_Result_1_Error____Object___(Async__get_async$(), LanguageService__parseEditor$(editor), (function(_arg1)
      {
        ...
        if ((matchValue.Items[0.000000].Tag == 0.000000)) 
        {
          ...
          else
          {
            ...
            if (linter) 
            {
              _4598 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
        ...
        else
        {
          if ((matchValue.Items[1.000000].Tag == 0.000000)) 
          {
            ...
            _4598 = Array__Map$Error__Object_Error__Object_((function(item)
            {
          ...
          else
          {
            ...
            if (linter) 
            {
              _4782 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
                return ErrorLinterProvider__mapLint$(editor, item);
              }), n_.Data);
            }
            ...
            var r_ = _4782;
            _4598 = Array__Concat$Object_Object_(Seq__OfList$Object___Object___(List__CreateCons$Object___Object___(r, List__CreateCons$Object___Object___(r_, List__Empty$Object___Object___()))));
          };
        };
        return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _4598);
      }));
    })));
});
...
GeneratorPane__makeHtml$ = (function(res)
{
...
GeneratorPane__navigateToEditor$ = (function(file,line,col)
{
    ...
    for (var _3740 = 0; _3740 <= (Array__Length$IPane_IPane_(arr) - 1); _3740++)
    {
      (function(idx)
      {
        var pane = arr[idx];
        if ((!found)) 
        {
          ...
          for (var _3739 = 0; _3739 <= (Array__Length$Object_Object_(_arr) - 1); _3739++)
          {
            (function(_idx)
            {
              var item = _arr[_idx];
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToFunction$(fileName, functionName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          ...
          GeneratorPane__navigateToEditor$(data.FileName, data.LineNumber, data.Location);
          _3672 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _3672 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _3672, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _3770;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _3770);
        })));
      }));
    })), {Tag: 0.000000});
});
...
GeneratorPane__replaceTextOnGeneratorHtmlPanel$ = (function(expanded,res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      return AsyncBuilder__Bind$JQuery__Unit_JQuery__Unit_(Async__get_async$(), AsyncBuilder__Delay$JQuery_JQuery_(Async__get_async$(), (function(_unitVar)
      {
        var el = ((TextOnViewHelpers__jq$("\u003cdiv /\u003e").addClass("content")).append(GeneratorPane__makeHtml$(res)));
        return AsyncBuilder__Return$JQuery_JQuery_(Async__get_async$(), el);
      })), (function(_arg1)
      {
        var html = _arg1;
        var pre = ((TextOnViewHelpers__jq$("\u003cpre /\u003e").text("(...)")).hide());
        var _3973;
        if (expanded) 
        {
          _3973 = "icon-chevron-down";
        }
        else
        {
          _3973 = "icon-chevron-right";
        };
        var icon = (TextOnViewHelpers__jq$("\u003cspan /\u003e").addClass(("icon " + _3973)));
        var padding = (((TextOnViewHelpers__jq$("\u003cdiv class=\u0027inset-panel padded\u0027/\u003e").append(icon)).append(pre)).append(html));
        var _3993;
        var _ignored0 = ((((TextOnViewHelpers__jq$((("\u003catom-panel id=\u0027" + identity(_3993)) + "\u0027 /\u003e")).addClass("top texton-block texton-html-block")).click((function(__arg1)
        {
          if (((pre.text()) == "(...)")) 
          {
            var __ignored0 = (icon.attr("class", "icon icon-chevron-down"));
            var ___ignored0 = ((pre.hide()).text(""));
            var ____ignored0 = (html.show());
          }
          else
          {
            var _____ignored0 = (icon.attr("class", "icon icon-chevron-right"));
            var ______ignored0 = ((pre.text("(...)")).show());
            var _______ignored0 = (html.hide());
          };
          return {};
        }))).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(padding)))).appendTo(TextOnViewHelpers__jq$(".texton")));
        return AsyncBuilder__Zero$(Async__get_async$());
      }));
    }));
});
GeneratorPane__sendToGenerator$ = (function(res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      var html = (new HtmlResult___ctor$(res.FileName, res.FunctionName));
      return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__replaceTextOnGeneratorHtmlPanel$(true, html), (function(_arg1)
      {
        ...
        return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__openTextOnGeneratorPane$(), (function(_arg1)
        {
          return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorStart$(editor, line), (function(_arg2)
          {
            ...
            if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(res)) 
            {
              ...
              {
                var _4061;
                return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4061);
              }));
            }
            else
            {
...
HtmlResult___ctor$ = (function(fileName,functionName)
{
    var __this = this;
    __this.fileName = fileName;
    __this.functionName = functionName;
});
...
{
    return LanguageService__send$NavigateData_NavigateData_(0, LanguageService__request$NavigateFunctionRequest_NavigateFunctionRequest_(LanguageService__url$("navigatefunctionrequest"), (new NavigateFunctionRequest___ctor$(fileName, functionName))));
});
...
LanguageService__request$NavigateFunctionRequest_NavigateFunctionRequest_ = (function(url,data)
{
    return AsyncBuilder__Delay$String___String___(Async__get_async$(), (function(unitVar)
    {
      Logger__logf$("Service", "Sending request: %O", [data]);
...
NavigateFunctionRequest___ctor$ = (function(FileName,FunctionName)
{
    var __this = this;
    __this.FileName = FileName;
    __this.FunctionName = FunctionName;
...
{
    var _4114;
    return (((window.atom).workspace).open("atom://config/packages/texton", _4114));
});
...
WebRequest__AsyncGetResponse$ = (function(req,unitVar1)
{
    return Async_1_FromContinuations$WebResponse_WebResponse_((function(tupledArg)
    {
      ...
      {
        _2340 = UTF8Encoding__GetString$(Replacements__utf8Encoding$(), Stream__get_Contents$(req.requestStream));
      };
      var body = _2340;
