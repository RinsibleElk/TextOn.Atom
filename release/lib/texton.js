      ...
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_Error____Object___FSharpOption_1_Result_1_Error____Object___(Async__get_async$(), LanguageService__parseEditor$(editor), (function(_arg1)
      {
        ...
        if ((matchValue.Items[0.000000].Tag == 0.000000)) 
        {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5650 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
        ...
        else
        {
          if ((matchValue.Items[1.000000].Tag == 0.000000)) 
          {
            ...
            _5650 = Array__Map$Error__Object_Error__Object_((function(item)
            {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5834 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
                return ErrorLinterProvider__mapLint$(editor, item);
              }), n_.Data);
            }
            ...
            var r_ = _5834;
            _5650 = Array__Concat$Object_Object_(Seq__OfList$Object___Object___(List__CreateCons$Object___Object___(r, List__CreateCons$Object___Object___(r_, List__Empty$Object___Object___()))));
          };
        };
        return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _5650);
      }));
    })));
});
...
GeneratorPane__copyToClipboard$ = (function(output)
{
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      var _5054;
      return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _5054);
    })), {Tag: 0.000000});
});
...
GeneratorPane__makeCombobox$ = (function(ty,name,value,options)
{
    ...
    if ((value == "")) 
    {
      _4132 = List__CreateCons$String_1String("", options);
    }
    else
    {
      _4132 = List__CreateCons$String_1String(value, List__CreateCons$String_1String("", List__Filter$String_1String((function(o)
      {
        return (o != value);
      }), options)));
    };
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToAttribute$(fileName, attributeName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          ...
          _4047 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _4047 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4047, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4084;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4084);
        })));
      }));
    })), {Tag: 0.000000});
});
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToVariable$(fileName, variableName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          var data = Option__GetValue$Result_1_NavigateData_Result_1_NavigateData_(navigationResult).Data;
          GeneratorPane__navigateToEditor$(data.FileName, (data.LineNumber - 1), (data.Location - 1));
          _4514 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _4514 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4514, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4551;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4551);
        })));
      }));
    })), {Tag: 0.000000});
});
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generate$(), (function(_arg3)
      {
        ...
        if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(generatorData)) 
        {
          ...
          _4746 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__replaceTextOnGeneratorHtmlPanel$(data), (function(_arg4)
          {
            var _4767;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4767);
          }));
        }
        else
        {
          _4746 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4746, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4779;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4779);
        })));
      }));
    })), {Tag: 0.000000});
});
GeneratorPane__replaceTextOnGeneratorHtmlPanel$ = (function(res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      var _5074;
      var q = ((((TextOnViewHelpers__jq$((("\u003catom-panel id=\u0027" + identity(_5074)) + "\u0027 /\u003e")).addClass("top texton-block texton-html-block")).append((GeneratorPane__divPadded$().append(paddedTitle)))).append((GeneratorPane__divPadded$().append(paddedAttributes)))).append((GeneratorPane__divPadded$().append(paddedVariables))));
      var _5087;
      if (res.CanGenerate) 
      {
        var _5096;
        _5087 = (q.append((GeneratorPane__divPadded$().append(makePaddedGeneratorButton(_5096)))));
      }
      else
      {
        _5087 = q;
      ...
      {
        _5097 = (_q.append((GeneratorPane__divPadded$().append(makePaddedGeneratorOutput(res.Output)))));
      }
      else
      {
        _5097 = _q;
        ...
        return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__openTextOnGeneratorPane$(closeIfNotFound), (function(_arg1)
        {
          return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorStart$(editor, line), (function(_arg2)
          {
            ...
            if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(res)) 
            {
              ...
              {
                var _5132;
                return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _5132);
              }));
            }
            else
            {
...
GeneratorPane__valueSet$ = (function(ty,name,value)
{
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorValueSet$(ty, name, value), (function(_arg1)
      {
        ...
        {
          var data = Option__GetValue$Result_1_GeneratorData_Result_1_GeneratorData_(generatorData).Data;
          _4317 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__replaceTextOnGeneratorHtmlPanel$(data), (function(_arg2)
          {
            var _4338;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4338);
          }));
        }
        else
        {
          _4317 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4317, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4350;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4350);
        })));
      }));
    })), {Tag: 0.000000});
});
...
{
    var _5166;
    return (((window.atom).workspace).open("atom://config/packages/texton", _5166));
});
