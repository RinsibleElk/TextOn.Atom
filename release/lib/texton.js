      ...
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_Error____Object___FSharpOption_1_Result_1_Error____Object___(Async__get_async$(), LanguageService__parseEditor$(editor), (function(_arg1)
      {
        ...
        if ((matchValue.Items[0.000000].Tag == 0.000000)) 
        {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5759 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
        ...
        else
        {
          if ((matchValue.Items[1.000000].Tag == 0.000000)) 
          {
            ...
            _5759 = Array__Map$Error__Object_Error__Object_((function(item)
            {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5943 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
                return ErrorLinterProvider__mapLint$(editor, item);
              }), n_.Data);
            }
            ...
            var r_ = _5943;
            _5759 = Array__Concat$Object_Object_(Seq__OfList$Object___Object___(List__CreateCons$Object___Object___(r, List__CreateCons$Object___Object___(r_, List__Empty$Object___Object___()))));
          };
        };
        return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _5759);
      }));
    })));
});
...
GeneratorPane__copyToClipboard$ = (function(output)
{
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      var _4998;
      return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4998);
    })), {Tag: 0.000000});
});
...
GeneratorPane__makeCombobox$ = (function(ty,name,value,options)
{
    ...
    if ((value == "")) 
    {
      _4076 = List__CreateCons$String_1String("", options);
    }
    else
    {
      _4076 = List__CreateCons$String_1String(value, List__CreateCons$String_1String("", List__Filter$String_1String((function(o)
      {
        return (o != value);
      }), options)));
    };
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToVariable$(fileName, variableName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          var data = Option__GetValue$Result_1_NavigateData_Result_1_NavigateData_(navigationResult).Data;
          GeneratorPane__navigateToEditor$(data.FileName, (data.LineNumber - 1), (data.Location - 1));
          _4458 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _4458 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4458, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4495;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4495);
        })));
      }));
    })), {Tag: 0.000000});
});
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generate$(), (function(_arg3)
      {
        ...
        if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(generatorData)) 
        {
          ...
          _4690 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__replaceTextOnGeneratorHtmlPanel$(data), (function(_arg4)
          {
            var _4711;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4711);
          }));
        }
        else
        {
          _4690 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4690, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4723;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4723);
        })));
      }));
    })), {Tag: 0.000000});
});
GeneratorPane__replaceTextOnGeneratorHtmlPanel$ = (function(res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      var _5018;
      var q = ((((TextOnViewHelpers__jq$((("\u003catom-panel id=\u0027" + identity(_5018)) + "\u0027 /\u003e")).addClass("top texton-block texton-html-block")).append((GeneratorPane__divPadded$().append(paddedTitle)))).append((GeneratorPane__divPadded$().append(paddedAttributes)))).append((GeneratorPane__divPadded$().append(paddedVariables))));
      var _5031;
      if (res.CanGenerate) 
      {
        var _5040;
        _5031 = (q.append((GeneratorPane__divPadded$().append(makePaddedGeneratorButton(_5040)))));
      }
      else
      {
        _5031 = q;
      ...
      {
        _5041 = (_q.append((GeneratorPane__divPadded$().append(makePaddedGeneratorOutput(res.Output)))));
      }
      else
      {
        _5041 = _q;
        ...
        return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__openTextOnGeneratorPane$(closeIfNotFound), (function(_arg1)
        {
          return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorStart$(editor, line), (function(_arg2)
          {
            ...
            if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(res)) 
            {
              ...
              {
                var _5076;
                return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _5076);
              }));
            }
            else
            {
...
GeneratorPane__valueSet$ = (function(ty,name,value)
{
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorValueSet$(ty, name, value), (function(_arg1)
      {
        ...
        {
          var data = Option__GetValue$Result_1_GeneratorData_Result_1_GeneratorData_(generatorData).Data;
          _4261 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__replaceTextOnGeneratorHtmlPanel$(data), (function(_arg2)
          {
            var _4282;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4282);
          }));
        }
        else
        {
          _4261 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4261, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4294;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4294);
        })));
      }));
    })), {Tag: 0.000000});
});
...
{
    var _5303;
    return (((window.atom).workspace).open("atom://config/packages/texton", _5303));
});
...
TextOnGenerator__updateGenerator$ = (function(_this,unitVar0)
{
    var ignored0 = Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__updateGenerator$(), (function(_arg1)
      {
        ...
        {
          var data = Option__GetValue$Result_1_GeneratorData_Result_1_GeneratorData_(generatorData).Data;
          _5198 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__replaceTextOnGeneratorHtmlPanel$(data), (function(_arg2)
          {
            var _5219;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _5219);
          }));
        }
        else
        {
          _5198 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _5198, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _5231;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _5231);
        })));
      }));
    })), {Tag: 0.000000});
});
