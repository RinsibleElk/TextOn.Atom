...
Array__Fold$OutputString__JQuery_OutputString__JQuery_ = (function(f,seed,xs)
{
    return Array__FoldIndexed$JQuery__OutputString_JQuery__OutputString_((function(_arg1)
    {
      return (function(acc)
      {
        return (function(x)
...
Array__FoldIndexed$JQuery__OutputString_JQuery__OutputString_ = (function(f,seed,xs)
{
    var acc = seed;
...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _3910;
      return Async__invokeCont$Unit_Unit_(k, _3910);
    }));
});
      ...
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_Error____Object___FSharpOption_1_Result_1_Error____Object___(Async__get_async$(), LanguageService__parseEditor$(editor), (function(_arg1)
      {
        ...
        if ((matchValue.Items[0.000000].Tag == 0.000000)) 
        {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5452 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
        ...
        else
        {
          if ((matchValue.Items[1.000000].Tag == 0.000000)) 
          {
            ...
            _5452 = Array__Map$Error__Object_Error__Object_((function(item)
            {
          ...
          else
          {
            ...
            if (linter) 
            {
              _5636 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
                return ErrorLinterProvider__mapLint$(editor, item);
              }), n_.Data);
            }
            ...
            var r_ = _5636;
            _5452 = Array__Concat$Object_Object_(Seq__OfList$Object___Object___(List__CreateCons$Object___Object___(r, List__CreateCons$Object___Object___(r_, List__Empty$Object___Object___()))));
          };
        };
        return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _5452);
      }));
    })));
});
...
GenerateRequest___ctor$ = (function(Blank)
{
    var __this = this;
    __this.Blank = Blank;
});
...
GeneratorPane__makeAttributes$ = (function(res)
{
    ...
    {
      return ((TextOnViewHelpers__jq$("\u003ctr /\u003e").append((GeneratorPane__td$().append(GeneratorPane__makeLinkForAttribute$(res.FileName, att.Name))))).append((GeneratorPane__td$().append(GeneratorPane__makeCombobox$("Attribute", att.Name, att.Value, List__OfArray$String_1String(att.Suggestions))))));
    }), res.Attributes);
...
GeneratorPane__makeCombobox$ = (function(ty,name,value,options)
{
    var _4135;
    if ((value == "")) 
    {
      _4135 = List__CreateCons$String_1String("", options);
    }
    else
    {
      _4135 = List__CreateCons$String_1String(value, List__CreateCons$String_1String("", List__Filter$String_1String((function(o)
      {
        return (o != value);
      }), options)));
    };
...
GeneratorPane__makeLinkForLine$Int32_Int32 = (function(file,line,text)
{
    return ((TextOnViewHelpers__jq$("\u003ca /\u003e").append(text)).click((function(_arg3)
    {
      return GeneratorPane__navigateToFileLine$Int32_Int32(file, line);
    })));
});
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToAttribute$(fileName, attributeName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          ...
          _4050 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _4050 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4050, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4087;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4087);
        })));
      }));
    })), {Tag: 0.000000});
});
GeneratorPane__navigateToEditor$ = (function(file,line,col)
{
    ...
    for (var _3896 = 0; _3896 <= (Array__Length$IPane_IPane_(arr) - 1); _3896++)
    {
      (function(idx)
      {
        var pane = arr[idx];
        if ((!found)) 
        {
          ...
          for (var _3895 = 0; _3895 <= (Array__Length$Object_Object_(_arr) - 1); _3895++)
          {
            (function(_idx)
            {
              var item = _arr[_idx];
...
GeneratorPane__navigateToFileLine$Int32_Int32 = (function(file,line)
{
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      GeneratorPane__navigateToEditor$(file, 0, 0);
      return AsyncBuilder__Zero$(Async__get_async$());
    })), {Tag: 0.000000});
});
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToFunction$(fileName, functionName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          var data = Option__GetValue$Result_1_NavigateData_Result_1_NavigateData_(navigationResult).Data;
          GeneratorPane__navigateToEditor$(data.FileName, (data.LineNumber - 1), (data.Location - 1));
          _3824 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _3824 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _3824, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _3926;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _3926);
        })));
      }));
    })), {Tag: 0.000000});
});
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToVariable$(fileName, variableName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          var data = Option__GetValue$Result_1_NavigateData_Result_1_NavigateData_(navigationResult).Data;
          GeneratorPane__navigateToEditor$(data.FileName, (data.LineNumber - 1), (data.Location - 1));
          _4520 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _4520 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4520, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4557;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4557);
        })));
      }));
    })), {Tag: 0.000000});
});
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generate$(), (function(_arg3)
      {
        ...
        if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(generatorData)) 
        {
          ...
          _4737 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__replaceTextOnGeneratorHtmlPanel$(data), (function(_arg4)
          {
            var _4758;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4758);
          }));
        }
        else
        {
          _4737 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4737, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4770;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4770);
        })));
      }));
    })), {Tag: 0.000000});
});
GeneratorPane__replaceTextOnGeneratorHtmlPanel$ = (function(res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      var makePaddedGeneratorButton = (function(unitVar0)
      {
        ...
        var generatorButton = (((TextOnViewHelpers__jq$("\u003cdiv /\u003e").addClass("content")).append("\u003ch2\u003eGenerate\u003c/h2\u003e")).append(button));
        return (TextOnViewHelpers__jq$("\u003cdiv class=\u0027inset-panel padded\u0027/\u003e").append(generatorButton));
      });
      var makePaddedGeneratorOutput = (function(output)
      {
        var folder = (function(q)
        {
          return (function(t)
          {
            return (q.append(GeneratorPane__makeLinkForLine$Int32_Int32(t.File, t.LineNumber, t.Value)));
          });
        });
        var state = TextOnViewHelpers__jq$("\u003cdiv /\u003e");
        var _output = (function(array)
        {
          return Array__Fold$OutputString__JQuery_OutputString__JQuery_(folder, state, array);
        })(output);
        var paddedOutput = (((TextOnViewHelpers__jq$("\u003cdiv /\u003e").addClass("content")).append("\u003ch2\u003eOutput\u003c/h2\u003e")).append(_output));
        return (TextOnViewHelpers__jq$("\u003cdiv class=\u0027inset-panel padded\u0027/\u003e").append(paddedOutput));
      });
      var _4872;
      var q = ((((TextOnViewHelpers__jq$((("\u003catom-panel id=\u0027" + identity(_4872)) + "\u0027 /\u003e")).addClass("top texton-block texton-html-block")).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedTitle)))).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedAttributes)))).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedVariables))));
      var _4887;
      if (res.CanGenerate) 
      {
        var _4897;
        _4887 = (q.append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(makePaddedGeneratorButton(_4897)))));
      }
      else
      {
        _4887 = q;
      ...
      {
        _4898 = (_q.append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(makePaddedGeneratorOutput(res.Output)))));
      }
      else
      {
        _4898 = _q;
        ...
        return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__openTextOnGeneratorPane$(closeIfNotFound), (function(_arg1)
        {
          return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorStart$(editor, line), (function(_arg2)
          {
            ...
            if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(res)) 
            {
              ...
              {
                var _4934;
                return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4934);
              }));
            }
            else
            {
...
GeneratorPane__valueSet$ = (function(ty,name,value)
{
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorValueSet$(ty, name, value), (function(_arg1)
      {
        ...
        {
          var data = Option__GetValue$Result_1_GeneratorData_Result_1_GeneratorData_(generatorData).Data;
          _4320 = AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__replaceTextOnGeneratorHtmlPanel$(data), (function(_arg2)
          {
            var _4341;
            return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4341);
          }));
        }
        else
        {
          _4320 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _4320, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _4353;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4353);
        })));
      }));
    })), {Tag: 0.000000});
});
...
{
    return LanguageService__send$GeneratorData_GeneratorData_(0, LanguageService__request$GenerateRequest_GenerateRequest_(LanguageService__url$("generate"), (new GenerateRequest___ctor$(""))));
});
...
List__Filter$String_1String = (function(f,xs)
{
...
{
    var _4968;
    return (((window.atom).workspace).open("atom://config/packages/texton", _4968));
});
...
WebRequest__AsyncGetResponse$ = (function(req,unitVar1)
{
    return Async_1_FromContinuations$WebResponse_WebResponse_((function(tupledArg)
    {
      ...
      {
        _997 = UTF8Encoding__GetString$(Replacements__utf8Encoding$(), Stream__get_Contents$(req.requestStream));
      };
      var body = _997;
