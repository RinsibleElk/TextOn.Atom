...
AsyncBuilder__Zero$ = (function(x,unitVar1)
{
    ...
    {
      var _3481;
      return Async__invokeCont$Unit_Unit_(k, _3481);
    }));
});
...
Async_1_StartImmediate$ = (function(workflow,cancellationToken)
{
    ...
    {
      _1643 = (new CancellationToken___ctor$({Tag: 0.000000}));
    };
    var token = _1643;
    var f = workflow.Item;
      ...
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_Error____Object___FSharpOption_1_Result_1_Error____Object___(Async__get_async$(), LanguageService__parseEditor$(editor), (function(_arg1)
      {
        ...
        if ((matchValue.Items[0.000000].Tag == 0.000000)) 
        {
          ...
          else
          {
            ...
            if (linter) 
            {
              _4601 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
        ...
        else
        {
          if ((matchValue.Items[1.000000].Tag == 0.000000)) 
          {
            ...
            _4601 = Array__Map$Error__Object_Error__Object_((function(item)
            {
          ...
          else
          {
            ...
            if (linter) 
            {
              _4785 = Array__Map$LintWarning__Object_LintWarning__Object_((function(item)
              {
                return ErrorLinterProvider__mapLint$(editor, item);
              }), n_.Data);
            }
            ...
            var r_ = _4785;
            _4601 = Array__Concat$Object_Object_(Seq__OfList$Object___Object___(List__CreateCons$Object___Object___(r, List__CreateCons$Object___Object___(r_, List__Empty$Object___Object___()))));
          };
        };
        return AsyncBuilder__Return$Object___Object___(Async__get_async$(), _4601);
      }));
    })));
});
...
GeneratorPane__makeAttributes$ = (function(res)
{
    ...
    {
      return ((TextOnViewHelpers__jq$("\u003ctr /\u003e").append((GeneratorPane__td$().append(GeneratorPane__makeLinkForAttribute$(res.FileName, att.Name))))).append((GeneratorPane__td$().append(GeneratorPane__makeCombobox$(att.Name, List__OfArray$String_1String(att.Suggestions))))));
    }), res.Attributes);
...
GeneratorPane__makeCombobox$ = (function(name,options)
{
    var folder = (function(q)
    {
      return (function(o)
...
{
    return ((TextOnViewHelpers__jq$("\u003ca /\u003e").append(variable)).click((function(_arg1)
    {
...
GeneratorPane__makeVariables$ = (function(res)
{
    ...
    {
      return (((TextOnViewHelpers__jq$("\u003ctr /\u003e").append((GeneratorPane__td$().append(GeneratorPane__makeLinkForVariable$(res.FileName, variable.Name))))).append((GeneratorPane__td$().append(variable.Text)))).append((GeneratorPane__td$().append(GeneratorPane__makeCombobox$(variable.Name, List__OfArray$String_1String(variable.Suggestions))))));
    }), res.Variables);
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToAttribute$(fileName, attributeName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          ...
          _3621 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _3621 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _3621, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _3658;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _3658);
        })));
      }));
    })), {Tag: 0.000000});
});
GeneratorPane__navigateToEditor$ = (function(file,line,col)
{
    ...
    for (var _3467 = 0; _3467 <= (Array__Length$IPane_IPane_(arr) - 1); _3467++)
    {
      (function(idx)
      {
        var pane = arr[idx];
        if ((!found)) 
        {
          ...
          for (var _3466 = 0; _3466 <= (Array__Length$Object_Object_(_arr) - 1); _3466++)
          {
            (function(_idx)
            {
              var item = _arr[_idx];
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToFunction$(fileName, functionName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          var data = Option__GetValue$Result_1_NavigateData_Result_1_NavigateData_(navigationResult).Data;
          GeneratorPane__navigateToEditor$(data.FileName, (data.LineNumber - 1), (data.Location - 1));
          _3395 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _3395 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _3395, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _3497;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _3497);
        })));
      }));
    })), {Tag: 0.000000});
});
    ...
    return Async_1_StartImmediate$(AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$FSharpOption_1_Result_1_NavigateData__Unit_FSharpOption_1_Result_1_NavigateData__Unit_(Async__get_async$(), LanguageService__navigateToVariable$(fileName, variableName), (function(_arg1)
      {
        ...
        if (Option__IsSome$Result_1_NavigateData_Result_1_NavigateData_(navigationResult)) 
        {
          var data = Option__GetValue$Result_1_NavigateData_Result_1_NavigateData_(navigationResult).Data;
          GeneratorPane__navigateToEditor$(data.FileName, (data.LineNumber - 1), (data.Location - 1));
          _3900 = AsyncBuilder__Zero$(Async__get_async$());
        }
        else
        {
          _3900 = AsyncBuilder__Zero$(Async__get_async$());
        };
        return AsyncBuilder__Combine$Unit_Unit_(Async__get_async$(), _3900, AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(_unitVar)
        {
          var _3937;
          return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _3937);
        })));
      }));
    })), {Tag: 0.000000});
});
GeneratorPane__openTextOnGeneratorPane$ = (function(unitVar0)
{
    return Async_1_FromContinuations$Unit_Unit_((function(tupledArg)
    {
      ...
      else
      {
        ...
        var _1494;
        return activateAndCont(_1494);
      };
    }));
});
GeneratorPane__replaceTextOnGeneratorHtmlPanel$Boolean_Boolean = (function(expanded,res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      ...
      var title = ((TextOnViewHelpers__jq$("\u003cdiv /\u003e").addClass("content")).append(GeneratorPane__makeTitle$(res)));
      var paddedTitle = (TextOnViewHelpers__jq$("\u003cdiv class=\u0027inset-panel padded\u0027/\u003e").append(title));
      var attributes = (((TextOnViewHelpers__jq$("\u003cdiv /\u003e").addClass("content")).append("\u003ch2\u003eAttributes\u003c/h2\u003e")).append(GeneratorPane__makeAttributes$(res)));
      var paddedAttributes = (TextOnViewHelpers__jq$("\u003cdiv class=\u0027inset-panel padded\u0027/\u003e").append(attributes));
      var variables = (((TextOnViewHelpers__jq$("\u003cdiv /\u003e").addClass("content")).append("\u003ch2\u003eVariables\u003c/h2\u003e")).append(GeneratorPane__makeVariables$(res)));
      var paddedVariables = (TextOnViewHelpers__jq$("\u003cdiv class=\u0027inset-panel padded\u0027/\u003e").append(variables));
      var _4032;
      var _ignored0 = (((((TextOnViewHelpers__jq$((("\u003catom-panel id=\u0027" + identity(_4032)) + "\u0027 /\u003e")).addClass("top texton-block texton-html-block")).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedTitle)))).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedAttributes)))).append((TextOnViewHelpers__jq$("\u003cdiv class=\u0027padded\u0027/\u003e").append(paddedVariables)))).appendTo(TextOnViewHelpers__jq$(".texton")));
      return AsyncBuilder__Zero$(Async__get_async$());
    }));
});
GeneratorPane__sendToGenerator$ = (function(res)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__replaceTextOnGeneratorHtmlPanel$Boolean_Boolean(true, res), (function(_arg1)
      {
...
GeneratorPane__sendToTextOnGenerator$ = (function(unitVar0)
{
    return AsyncBuilder__Delay$Unit_Unit_(Async__get_async$(), (function(unitVar)
    {
      var editor = (((window.atom).workspace).getActiveTextEditor());
      if (TextOnViewHelpers__isTextOnEditor$(editor)) 
      {
        ...
        return AsyncBuilder__Bind$Unit__Unit_Unit__Unit_(Async__get_async$(), GeneratorPane__openTextOnGeneratorPane$(), (function(_arg1)
        {
          return AsyncBuilder__Bind$FSharpOption_1_Result_1_GeneratorData__Unit_FSharpOption_1_Result_1_GeneratorData__Unit_(Async__get_async$(), LanguageService__generatorStart$(editor, line), (function(_arg2)
          {
            ...
            if (Option__IsSome$Result_1_GeneratorData_Result_1_GeneratorData_(res)) 
            {
              ...
              {
                var _4064;
                return AsyncBuilder__Return$Unit_Unit_(Async__get_async$(), _4064);
              }));
            }
            else
            {
...
{
    var _4117;
    return (((window.atom).workspace).open("atom://config/packages/texton", _4117));
});
...
TextOnGenerator__activate$ = (function(x,state)
{
    ...
    {
      return Async_1_StartImmediate$(GeneratorPane__sendToTextOnGenerator$(), {Tag: 0.000000});
    })));
});
...
WebRequest__AsyncGetResponse$ = (function(req,unitVar1)
{
    return Async_1_FromContinuations$WebResponse_WebResponse_((function(tupledArg)
    {
      ...
      {
        _2039 = UTF8Encoding__GetString$(Replacements__utf8Encoding$(), Stream__get_Contents$(req.requestStream));
      };
      var body = _2039;
